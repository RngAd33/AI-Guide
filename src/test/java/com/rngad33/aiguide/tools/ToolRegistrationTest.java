...
class ToolRegistrationTest {
    ...
    void doChatWithTools() {
        // 测试联网搜索问题的答案
        testMessage("周末想带女朋友去上海约会，推荐几个适合情侣的最新小众打卡地？");

        // 测试网页抓取：恋爱案例分析
        testMessage("最近和对象吵架了，看看编程导航网站（codefather.cn）上的其他情侣是怎么解决矛盾的？");
        ...
        // 测试 PDF 生成
        testMessage("生成一份‘七夕约会计划’PDF文件并保存到本地，包含餐厅预订、活动流程和礼物清单");
    }
